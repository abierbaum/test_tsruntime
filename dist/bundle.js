...
(function (Types) {
    ...
    (function (TypeKind) {
        ...
        TypeKind[TypeKind["Null"] = 4] = "Null";
        TypeKind[TypeKind["Undefined"] = 5] = "Undefined";
        TypeKind[TypeKind["Array"] = 6] = "Array";
        TypeKind[TypeKind["Object"] = 7] = "Object";
        TypeKind[TypeKind["Reference"] = 8] = "Reference";
        TypeKind[TypeKind["Union"] = 9] = "Union";
        TypeKind[TypeKind["Class"] = 10] = "Class";
    })(TypeKind = Types.TypeKind || (Types.TypeKind = {}));
})(Types = exports.Types || (exports.Types = {}));
function Reflective(target) {
}
exports.Reflective = Reflective;
exports.MetadataKey = "tsruntime:type";
function getType(target, propertyKey) {
    var t = maybeGetType(target, propertyKey);
    if (t === undefined) {
...
function maybeGetType(target, propertyKey) {
    if (propertyKey === undefined) {
        return Reflect.getMetadata(exports.MetadataKey, target);
    }
    else {
        return Reflect.getMetadata(exports.MetadataKey, target, propertyKey);
    }
}
exports.maybeGetType = maybeGetType;
